...
<body class="scrollbar">
				...
				<div class="collapse navbar-collapse" id="sidenav-collapse-main"
					...
					<ul class="navbar-nav">
						<li class="nav-item"><a class="nav-link hover12"
							href="dashboard.do"> <i class="ni ni-chart-bar-32 text-red "></i>
								La Form 트렌드 분석
						</a></li>
						<li class="nav-item active"><a
							class="nav-link hover12 active" href="productAnalysis.do"> <i
	...
	<div class="main-content">
		...
		<nav class="navbar navbar-top navbar-expand-md navbar-dark"
			...
			<div class="container-fluid">
				...
				<a
					...
					href="productAnalysis.do">Check'O</a>

				<!-- 위쪽 버튼------------------------------------------------------------------------------------------------------>
				<div class="col" style="padding-left: 45px;">
					<ul class="nav nav-pills justify-content-start">
						<li class="nav-item"><a href="Addproduct.do"
							class="nav-link we12 py-2 px-3"> <span
								class="d-none d-md-block">제품 추가</span> <span class="d-md-none">제품
									추가</span>
						</a></li>
						<li>
							<div></div>
						</li>
						<li class="nav-item"><a href="Addreview.do"
							class="nav-link we12 py-2 px-3"> <span
								class="d-none d-md-block">리뷰 추가</span> <span class="d-md-none">리뷰
									추가</span>
						</a></li>
					</ul>
				</div>
				...
				<form
					...
					<div class="form-group mb-0">
						<div class="input-group input-group-alternative">
							...
							<!-- 챗GPT API 들어갈 input 태그-->
							<input class="form-control" placeholder="ChatGPT에게 질문하기"
		...
		<div
			class="header bg-gradient-primary2 pb-8 pt-5 pt-md-8 position-relative"></div>
		...
		<div class="container-fluid mt--7">
			...
			<div class="col">
				...
				<ul class="nav nav-pills justify-content-xl-between"
					...
					<c:forEach var="product" items="${prodList}" begin="1">
						<li class="nav-item mr-2 mr-md-0" data-toggle="chart"
							...
							class="nav-link ar123 py-2 px-3" data-toggle="tab"> <span
								class="d-none d-md-block">
									<div class="hover13">
										<figure style="margin-bottom: 6px; margin-top: 6px;">
											<img src="data:image/png;base64, ${product.prod_img}" alt=""
												style="width: 450px; height: 450px;">
										</figure>
									</div>
							</span> <span class="d-md-none">${product.prod_name}</span> <span
								class="prod_idx" style="display: none">${product.prod_idx}</span>
						</a></li>
					</c:forEach>
			...
			<div class="row">
				<div class="col-xl-8 mb-5 mb-xl-0">
					<div class="card shadow">
						<div>
							<div class="card-body"
								style="background-color: #ffffff; height: 420px;">
								<!-- 내용 -->
								<div>
									<figure>
										<img src="" alt="">
	...
	<!--   Argon JS   -->
	<script
		src="${pageContext.request.contextPath}/resources/js/argon-dashboard.min.js?v=1.1.2"></script>
